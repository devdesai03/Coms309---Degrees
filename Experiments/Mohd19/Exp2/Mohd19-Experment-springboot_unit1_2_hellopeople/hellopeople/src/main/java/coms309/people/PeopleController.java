...
public class PeopleController {
    ...
    public ResponseEntity<Person> updatePerson(@PathVariable int id, @RequestBody Person personDetails) {
        Optional<Person> optionalPerson = Optional.ofNullable(peopleList.get(id));
        ...
        if (optionalPerson.isPresent()) {
            ...
            // Save the updated person (assuming you have a repository)
            updatePerson.save(updatePerson);
